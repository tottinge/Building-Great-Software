...
By default, the above command will do the following:
    ...
    --  Install the version-numbered "scons-2.1.0.alpha.20101125" and "sconsign-2.1.0.alpha.20101125"
    ...
    --  Install scripts named "scons" and "sconsign" scripts in the
        ...
        scripts be hard links or symbolic links to the "scons-2.1.0.alpha.20101125" and
        "sconsign-2.1.0.alpha.20101125" scripts by specifying the "--hardlink-scons"
        or "--symlink-scons" options on the command line.

    --  Install "scons-2.1.0.alpha.20101125.bat" and "scons.bat" wrapper scripts in the
        Python prefix directory on Windows (C:\Python*, for example).
        This can be disabled by specifying the "--no-install-bat" option
        on the command line.

        On UNIX or Linux systems, the "--install-bat" option may be
        specified to have "scons-2.1.0.alpha.20101125.bat" and "scons.bat" files
    ...
    --  Install the SCons build engine (a Python module) in an
        ...
        (/usr/lib/scons-2.1.0.alpha.20101125 or C:\Python*\scons-2.1.0.alpha.20101125, for example).
...
src/README.txt 5183 2010/11/25 14:46:21 bdeegan
